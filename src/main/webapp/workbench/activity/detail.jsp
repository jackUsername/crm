            ...
            $.ajax({
                ...
                success:function (data) {
                    if(data.success){
                        ...
                        html+= '&nbsp;&nbsp;&nbsp;&nbsp;';
                        html+= '<a class="myHref" href="javascript:void(0);" onclick="delectRemark(\''+data.ar.id+'\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>';
                        html+= '</div>';
                        html+= '</div>';
                        html+= '</div>';
		...
		$("#updateRemarkBtn").click(function () {
            ...
            $.ajax({
                ...
                success:function (data) {
                    if(data.success){
                        //修改成功之后
						//需要更新div中相应的信息，需要更新的内容有noteContent，editTime,
        ...
        $.ajax({
            ...
            success:function (data) {
               ...
               $.each(data,function (i,n) {
                ...
                html+= '<div style="position: relative; left: 500px; top: -30px; height: 30px; width: 100px; display: none;">';
                html+= '<a class="myHref" href="javascript:void(0);" onclick="enditRemark(\''+n.id+'\')"><span class="glyphicon glyphicon-edit" style="font-size: 20px; color: #FF0000;"></span></a>';
                html+= '&nbsp;&nbsp;&nbsp;&nbsp;';
